/*------------------------------------------------------------------------------------------------------/
| Program : ISB:PublicWorks/~/~/~
| Event   : InspectionScheduleBefore
|
| Client  : Placer County (placerco)
| Usage   : Inspection Result Submit Before for all PublicWorks records.
| 
|
| Requires: EMSE 3.0 and Standard Choice: "EMSE_EXECUTE_OPTIONS": "SCRIPT" to be Active.
|
| Notes   : Abe 04/10/2026 Converted to EMSE 3.0 from StdChoice ISB:PublicWorks
|                
/------------------------------------------------------------------------------------------------------*/
...
logDebug("Processing ISB:PublicWorks/~/~/~ ...");
...
if(balanceDue > 0) {
    ...
    vString += balanceDue; 
    vString += " for this DPW Permit. No additional inspections can be scheduled until the balance due it paid.<br><br>";
...
if(feeGetTotByDateRange(dateAdd(null,-730),dateAdd(null,0),"NEW") > 0){
    ...
    vString += " for this DPW Permit. No additional inspections can be scheduled until the fees are assessed and paid.<br><br>";
