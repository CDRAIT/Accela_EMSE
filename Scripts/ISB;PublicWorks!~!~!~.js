...
if(balanceDue > 0) {
    ...
    vString += balanceDue; 
    vString += " for this DPW Permit. No additional inspections can be scheduled until the balance due it paid.<br>";
...
if(feeGetTotByDateRange(dateAdd(null,-730),dateAdd(null,0),"NEW") > 0){
    ...
    vString += " for this DPW Permit. No additional inspections can be scheduled until the fees are assessed and paid.<br>";
