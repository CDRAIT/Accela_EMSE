...
var mailFrom = defaultFrom; 
var mailCC = "eaftahi@placer.ca.gov"; //Abe: I waana figure this out! 
...
function getParamsForPublic(publicUserModel) { 
	...
	if (publicUserModel != null) { 
		...
		if (peopleList != null && peopleList.size() > 0) { 
			...
			while (it.hasNext()) { peopleModel = it.next(); 
				break; 
			} 
		}
...
function sendNotification(userEmailTo, templateName) { 
	...
	if (result.getSuccess()) { 
		...
		{ 
			aa.log("Fail to send mail."); return false; 
		} 
	}
