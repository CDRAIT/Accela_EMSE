/*------------------------------------------------------------------------------------------------------/
| Program: batchExpireAtPlanCheckCom  Trigger: Batch    Client : Placer County
|
...
if (paramsOK) {
    var totalCount = 0;
    logMessage("START", "Start of Batch Job: batchExpireAtPlanCheckCom.");
    ...
    logMessage("END", "End of Job: batchExpireAtPlanCheckCom, Elapsed Time : " + elapsed() + " Seconds.");
    emailText = "Commercial Building Permits Expired at Plan Check: " + emailsentCount;
}
