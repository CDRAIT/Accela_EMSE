/*------------------------------------------------------------------------------------------------------/
| Program: batchEmailPlanCheckExpireCom  Trigger: Batch    Client : Placer County
|
...
var paramsAppPerType = "Commercial";
...
if (paramsOK) {
    var totalCount = 0;
    logMessage("START", "Start of Batch Job: batchEmailPlanCheckExpireCom.");
    ...
    logMessage("END", "End of Job: batchEmailPlanCheckExpireCom, Elapsed Time : " + elapsed() + " Seconds.");
    emailText = "Emails Sent for Commercial Building Permits that are about to Expire at Plan Check: " + emailsentCount;
}
