...
|         : Abe   09/10/2026  added IT Request# 3857 - Project Office evaluation for PREAPPS & non-publicUsers only
|
|         
|
/=============================================================================================*/
...
//IT Request # 3857- Project Office evaluation for PREAPPS & non-publicUsers only
if (!publicUser && appTypeArray[1] == "Pre-Application") {
	(AInfo['ParcelAttribute.BLDRESPONSE'] == "Tahoe") ? editAppSpecific("Project Office", "Tahoe") : editAppSpecific("Project Office", "Auburn");
}
//End of IT Request # 3857
