...
|
| Batch Requirements:
| added $$CUR_YEAR$$ to email notification
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
function aboutExpLics() 
{
	...
	var CAPIDS = []
	var FACIDS = [];
	var CAPIDSAB = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Abrasive Materials").getOutput();
	var CAPIDSAP = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Aggregate Processing").getOutput();
	var CAPIDSA = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Asphalt").getOutput();
	var CAPIDSGBP = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Biomass Processing").getOutput();
	var CAPIDSB = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Boiler").getOutput();
	var CAPIDSBST = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Bulk Storage Tank").getOutput();
	var CAPIDSCLAY = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Clay").getOutput();
	var CAPIDSC = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Coatings").getOutput();
	var CAPIDSCR = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Coffee Roasting").getOutput();
	var CAPIDSCT = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Combustion Turbine").getOutput();
	var CAPIDSCO = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Composting").getOutput();
	var CAPIDSCON = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Concrete").getOutput();
	var CAPIDSCTOWER = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Cooling Towers").getOutput();
	var CAPIDSCREM = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Crematory").getOutput();
	var CAPIDSDC = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Dry Cleaning").getOutput();
	var CAPIDSE = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Engine").getOutput();
	var CAPIDSEE = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Emergency Engine").getOutput();
	
	
	var CAPIDSFEE = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Flex Emergency Engine").getOutput();
	var CAPIDSFPE = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Flex Prime Engine").getOutput();
	var CAPIDSG = aa.cap.getByAppType("AirQuality","Stationary Source","Process","GDF").getOutput();
	var CAPIDSLDK = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Lumber Drying Kilns").getOutput();
	var CAPIDMH = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Materials Handling").getOutput();
	var CAPIDMHW = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Materials Handling (non-wood)").getOutput();
	var CAPIDSMC = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Miscellaneous Combustion").getOutput();
	var CAPIDMPM = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Miscallenous PM").getOutput();
	var CAPIDSMV = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Miscellaneous VOCs").getOutput();
	var CAPIDSPC = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Powder Coatings").getOutput();
	var CAPIDSP = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Prime Engine").getOutput();
	var CAPIDSL = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Sand Loading").getOutput();
	var CAPIDSSOLV = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Solvents").getOutput();
	var CAPIDSVE = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Vapor Extraction").getOutput();
	var CAPIDSWTP = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Wastewater Treatment Plant").getOutput();
	var CAPIDSWFPP = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Wood Fired Power Plant").getOutput();
	var CAPIDWPC = aa.cap.getByAppType("AirQuality","Stationary Source","Process","Woodcoater Particule Control").getOutput();
    ...
    for (x in CAPIDS) 
    {
				...
				var thrucheck = getAppSpecific("Throughput Sent",facID);
				...
				if(FACIDS.valueOf().toString().match(facID) == null)
					{
						FACIDS.push(facID);
					}
				}
	...
	for (x in FACIDS)
	{
		var faccapId = aa.cap.getCap(FACIDS[x]).getOutput();
		editAppSpecific("Throughput Sent","CHECKED",faccapId.getCapID())
	}
