/*------------------------------------------------------------------------------------------------------/
| Program: batchExpirePermitsCom  Trigger: Batch    Client : Placer County
|
...
if (paramsOK) {
    var totalCount = 0;
    logMessage("START", "Start of Batch Job: batchExpirePermitsCom.");
    ...
    logMessage("END", "End of Job: batchExpirePermitsCom, Elapsed Time : " + elapsed() + " Seconds.");
    emailText = "Commercial Building Permits Expired: " + emailsentCount;
}
