...
|
| Description of Intended Functionality: Tests for Plan Check Expiration dates occuring at 14 
| and at 60 days. Generates notice 
|
...
for(dd in numDaysArray)
{
	...
	if (paramsOK) 
	{
		...
		emailText = "<u>Number of Building permits nearing Plan Check expiration date /<u>" + expiredCount + "<br><br>" +
