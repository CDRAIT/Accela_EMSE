/*------------------------------------------------------------------------------------------------------/
| Program: batchNoticeAboutToExpireBLDPermits  Trigger: Batch    Client : Placerco
|
| Version 4.0 - Modified from version 3.0,  01/30/2017 Terry Dunn
|
...
| 14 and 60 days. Generates notice and sets cap status to About to Expire permit
|
| Criteria:
...
|   appSubtype = "Full Review","Limited","PV Solar"
| 
...
|                12/20/2023 Modified 'Expire' to replace current 'about to expire' notification
...
for(dd in numDaysArray)
{
	...
	if (paramsOK) {
		...
		emailText = "Number of Building permits about to expire: " + expiredCount;
	}
