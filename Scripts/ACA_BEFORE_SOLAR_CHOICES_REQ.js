/*------------------------------------------------------------------------------------------------------/
| Program : ACA_BEFORE_SOLAR_CHOICES_REQ.js  
| Event   : ACA_Before
|
...
var docListArray2 = aa.document
  ...
  .getOutput()
  .toArray();
var vCaLicContractorChoice = AInfo["California Licensed Contractor"];
var vAuthAgentChoice = AInfo["Authorized Agent"];
var vWCChoice1 = AInfo["WC OPT1"];
var vWCChoice2 = AInfo["WC OPT2"];
var vWCChoice3 = AInfo["WC OPT3"];
...
try {
  ...
  if (
    vCaLicContractorChoice != "CHECKED" &&
    vAuthAgentChoice != "CHECKED"
  ) {
    varCancel = true;
    varShowMessage = true;
    varComText =
      "You must select one (and only one) of either 'A California Licensed Contractor' or 'Authorized Agent'";
  }
  if (
    vWCChoice1 != "CHECKED" &&
    vWCChoice2 != "CHECKED" &&
    ...
    varShowMessage = true;
    varComText =
      "You must select one (and only one) of the Worker's compensation Declarations";
  }
