/*------------------------------------------------------------------------------------------------------/
| Program: batchExpireAtPlanCheckRes  Trigger: Batch    Client : Placer County
|
...
if (paramsOK) {
    var totalCount = 0;
    logMessage("START", "Start of Batch Job: batchExpireAtPlanCheckRes.");
    ...
    logMessage("END", "End of Job: batchExpireAtPlanCheckRes, Elapsed Time : " + elapsed() + " Seconds.");
    emailText = "Residential Building Permits Expired at Plan Check: " + emailsentCount;
}
