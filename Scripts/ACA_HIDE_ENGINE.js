...
if(cap != null)
{
	...
	if(conditionValue != null && ("Boiler" == conditionValue || "Gasoline Dispensing Operations (Retail and Non-Retail)" == conditionValue))
	{
	
		clearPageSectionData("2","2")   //the second 2 is the page number ,and First 2 is the step number
