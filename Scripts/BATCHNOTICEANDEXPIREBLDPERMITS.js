/*------------------------------------------------------------------------------------------------------/
| Program: batchNoticeAndExpireBldPermits  Trigger: Batch    Client : Placerco
|
...
if (paramsOK) {
    ...
    emailText = "Number of Building permits expired " + expiredCount + "<br>" + exceptionList;
}
...
*/			
			...
			if(matches(vToEmail,"",null,undefined,false) || vToEmail.indexOf("@") == -1)
			{
				exceptionList += capIDString + br;
			}
			...
			aa.print("applEmail = " + applEmail + "; primeEmail = " + primeEmail + "; owner = " + pOwnerEmail);
	...
	aa.print("No emails found list: " + br + exceptionList);
    return capCount;
}
