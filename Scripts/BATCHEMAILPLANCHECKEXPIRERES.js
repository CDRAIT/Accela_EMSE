/*------------------------------------------------------------------------------------------------------/
| Program: batchEmailPlanCheckExpireRes  Trigger: Batch    Client : Placer County
|
...
if (paramsOK) {
    var totalCount = 0;
    logMessage("START", "Start of Batch Job: batchEmailPlanCheckExpireRes.");
    ...
    logMessage("END", "End of Job: batchEmailPlanCheckExpireRes, Elapsed Time : " + elapsed() + " Seconds.");
    emailText = "Emails Sent for Residential Building Permits that are about to Expire at Plan Check: " + emailsentCount;
}
