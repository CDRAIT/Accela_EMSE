...
if(cap != null)
{
	...
	if(conditionValue != null && ("Internal Combustion Engine (emergency and prime use)" == conditionValue || "Boiler" == conditionValue))
	{
	
		clearPageSectionData("4","2")   //2 is the page number ,and 3 is the step number
