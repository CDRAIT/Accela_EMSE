/*------------------------------------------------------------------------------------------------------/
| Program: batchEmailExpireCom  Trigger: Batch    Client : Placer County
|
...
if (paramsOK) {
    var totalCount = 0;
    logMessage("START", "Start of Batch Job: batchEmailExpireCom.");
    ...
    logMessage("END", "End of Job: batchEmailExpireCom, Elapsed Time : " + elapsed() + " Seconds.");
    emailText = "Emails Sent for Commercial Building Permits that are about to Expire: " + emailsentCount;
}
