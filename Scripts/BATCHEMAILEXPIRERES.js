/*------------------------------------------------------------------------------------------------------/
| Program: batchEmailExpireRes  Trigger: Batch    Client : Placer County
|
...
if (paramsOK) {
    var totalCount = 0;
    logMessage("START", "Start of Batch Job: batchEmailExpireRes.");
    ...
    logMessage("END", "End of Job: batchEmailExpireRes, Elapsed Time : " + elapsed() + " Seconds.");
    emailText = "Emails Sent for Residential Building Permits that are about to Expire: " + emailsentCount;
}
