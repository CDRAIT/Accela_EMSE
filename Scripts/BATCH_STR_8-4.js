...
/*aa.print("PERMIT_NBR = " + PERMIT_NBR);
aa.print("PARCEL_NBR = " + PARCEL_NBR);
aa.print("TOT_CERT_NBR = " + TOT_CERT_NBR);
aa.print("PERMIT_STATUS = " + PERMIT_STATUS );
aa.print("ISSUED_DATE = " + issue_date);
aa.print("EXPIRATION_DATE = " + exp_date);
aa.print("PROPERTY_ADDRESS = " + PROPERTY_ADDRESS);
aa.print("PROPERTY_TYPE = " + PROPERTY_TYPE);
aa.print("PROPERTY_MGR_NAME = " + PROPERTY_MGR_NAME);
aa.print("PROPERTY_MGR_PHONE = " + PROPERTY_MGR_PHONE);
aa.print("PROPERTY_MGR_EMAIL = " + PROPERTY_MGR_EMAIL);
aa.print("PROPERTY_MGR_ADDRESS1 = " + PROPERTY_MGR_ADDRESS1);
aa.print("PROPERTY_MGR_ADDRESS2 = " + PROPERTY_MGR_ADDRESS2);
aa.print("OWNER_NAME = " + OWNER_NAME);
aa.print("OWNER_PHONE = " + OWNER_PHONE);
aa.print("OWNER_EMAIL = " + OWNER_EMAIL );
aa.print("OWNER_ADDRESS = " + OWNER_ADDRESS);
aa.print("LOCAL_CONTACT_NAME = " + LOCAL_CONTACT_NAME);
aa.print("LOCAL_CONTACT_PHONE = " + LOCAL_CONTACT_PHONE);
aa.print("LOCAL_CONTACT_EMAIL = " + LOCAL_CONTACT_EMAIL);
aa.print("LOCAL_CONTACT_ADDRESS1 = " + LOCAL_CONTACT_ADDRESS1);
aa.print("LOCAL_CONTACT_ADDRESS2 = " + LOCAL_CONTACT_ADDRESS2);
aa.print("SIGNATORY = " + SIGNATORY);
aa.print("PRIMARY_RESIDENCE = " + PRIMARY_RESIDENCE);
aa.print("ADU_DEED_RESTRICTED = " + ADU_DEED_RESTRICTED);
aa.print("STR_OWNERSHIP = " + STR_OWNERSHIP);
aa.print("DWELLING_TYPE = " + DWELLING_TYPE);
aa.print("NBR_OF_BEDROOMS = " + NBR_OF_BEDROOMS);
aa.print("REQUESTED_OCCUPANCY = " + REQUESTED_OCCUPANCY);
aa.print("MIN_BEDROOM_REQ_MET = " + MIN_BEDROOM_REQ_MET);
aa.print("ADDR_VISIBLE_STREET = " + ADDR_VISIBLE_STREET);
aa.print("PARKING_SPACES = " + PARKING_SPACES );
aa.print("PARKING_SPACE_LOCATIONS = " + PARKING_SPACE_LOCATIONS);
aa.print("SNOW_REMOVAL_BY = " + SNOW_REMOVAL_BY );
aa.print("NBR_FIRE_EXTINGUISHERS = " + NBR_FIRE_EXTINGUISHERS);
aa.print("FIRE_EXTINGUISHER_LOCATION = " + FIRE_EXTINGUISHER_LOCATION);
aa.print("FIRE_INSP_EXPIRY_DATE = " + FIRE_INSP_EXPIRY_DATE);
aa.print("SPRINKLER_SUPPRESSION = " + SPRINKLER_SUPPRESSION);
aa.print("NBR_SMOKE_ALARMS = " + NBR_SMOKE_ALARMS);
aa.print("SMOKE_ALARMS_LOCATION = " + SMOKE_ALARMS_LOCATION);
aa.print("NBR_CO_ALARMS = " + NBR_CO_ALARMS);
aa.print("CO_ALARMS_LOCATION = " + CO_ALARMS_LOCATION);
aa.print("CELL_PHONE_AVAILABLE = " + CELL_PHONE_AVAILABLE);
aa.print("LANDLINE_PHONE = " + LANDLINE_PHONE);
aa.print("VOIP_PHONE = " + VOIP_PHONE);
aa.print("MONITORED_ALARM = " + MONITORED_ALARM);
aa.print("GOOD_NEIGHBOR_AGREEMENT = " + GOOD_NEIGHBOR_AGREEMENT);
aa.print("COMPLIANT_BLD_CODE = " + COMPLIANT_BLD_CODE);
aa.print("RES_BLD_LICENSE = " + RES_BLD_LICENSE);
aa.print("PROPERTY_MGR = " + PROPERTY_MGR);*/
...
if(parcelcheck == "Match")
{
	capId = aa.cap.getCapID(PERMIT_NBR).getOutput();
...
if(capId == "")
{
	aa.print("Parcel " + nparcel + " was not updated or had a STR created");
}
...
var PROPERTY_MGR = '';
 ...
 var getSQL = "SELECT * FROM DATA_CONV.STR_PERMITS_DECKARD";
